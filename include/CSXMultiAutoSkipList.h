/*
   Description: Header file for XMultiAutoSkipList.
...
#ifndef CSXMultiAutoSkipListH
#define CSXMultiAutoSkipListH
...
private:
  ...
  XMultiAutoSkipList(const XMultiAutoSkipList &other ) { }

public:
  XCheckSkipNodes2

  XMultiAutoSkipList() : XList<value_type,node_type>() { }
  explicit XMultiAutoSkipList(const key_compare& comp) : XList<value_type,node_type>(), Compare(comp) { }
  ~XMultiAutoSkipList() { data=NULL; }
...
#define csarg2 XMultiAutoSkipList<X,CT,Pr>
