/*
   Description: Header file for XMultiAccessSkipList.
...
#ifndef CSXMultiAccessSkipListH
#define CSXMultiAccessSkipListH
...
public:
  ...
  {
  friend class XMultiAccessSkipList<X,K,CT,A,Pr>;
  public:
...
private:
  ...
  XMultiAccessSkipList(const XMultiAccessSkipList &other ) { }

public:
  XCheckSkipNodes2

  XMultiAccessSkipList() : XList<value_type,node_type>(), ValueCompare(Pr()) { }
  explicit XMultiAccessSkipList(const key_compare& comp) : XList<value_type,node_type>(), KeyCompare(comp), ValueCompare(comp) { }
  ~XMultiAccessSkipList() { data=NULL; }
...
bool operator==(const XMultiAccessSkipList<X,K,CT,A,Pr> &left, const XMultiAccessSkipList<X,K,CT,A,Pr> &right)
{
...
#define csarg2 XMultiAccessSkipList<X,K,CT,A,Pr>
